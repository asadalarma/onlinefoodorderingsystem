    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-1-column.html">1 column</a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-2-columns.html">2 columns</a>
                    </li>
                    <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-content-detached-left-sidebar.html">Detached left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-content-detached-left-sticky-sidebar.html">Detached sticky left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-content-detached-right-sidebar.html">Detached right sidebar</a>
                            </li>
                            <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-content-detached-right-sticky-sidebar.html">Detached sticky right sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    ...
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-light.html">Light layout</a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-dark.html">Dark layout</a>
                    </li>
                    <li><a class="menu-item" href="starter-kit/ltr/vertical-menu-template/layout-semi-dark.html">Semi dark layout</a>
                    </li>
                </ul>
            </li>
            <li class=" navigation-header">
