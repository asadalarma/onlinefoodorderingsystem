                                    ...
                                    <input type="hidden" name="userid" value="<?php echo $id; ?>">
                                       <?php $row = getUserRecord($conn,$id); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" placeholder="UserName" name="username" type="text" id="username" value="<?php echo isset($row["username"]) ? $row["username"] : null; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" placeholder="Old Password" name="oldpassword" type="password" id="oldpassword" minlength="6">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" placeholder="New Password" name="newpassword" type="password" id="newpassword" minlength="6">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" placeholder="Confirm Password" name="confirmpassword" type="password" id="confirmpassword" minlength="6">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions right">
                                            ...
                                            <button type="submit" name="editadmins" class="btn btn-primary"><i class="fa fa-check-square-o"></i> Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
